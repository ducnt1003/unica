...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        ...
        <div class="navbar-collapse row justify-content-center" id="navbarSupportedContent">
            <div class="nav-item active col-md-4 ">
                <img class="img-fluid" src="/image/logo-unica.png" alt="">
            </div>
            <div class="nav-item active col-md-4">
                <div class="row no-gutters">
                    <div class="col">
                        <input class="form-control border-secondary border-right-0 rounded-0" type="search"
                         id="example-search-input4" placeholder="Tìm khóa học, giảng viên">
                    </div>
                    <div class="col-auto">
